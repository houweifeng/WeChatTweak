...
//禁止撤回消息
CHMethod(3, void, CMessageMgr,DelMsg,id,arg1,MsgList,id,arg2,DelAll,_Bool,arg3){
    NSLog(@"hook delmsg, ignore it");
}

CHMethod(2, void,CMessageMgr,DelMsg,id,arg1,MsgWrap,id,arg2){
    NSLog(@"hook delmsg, ignore it");
}
...
__attribute__((constructor)) static void entry()
{
    ...
    CHClassHook(3, CMessageMgr,DelMsg,MsgList,DelAll);
    CHClassHook(2, CMessageMgr,DelMsg,MsgWrap);
